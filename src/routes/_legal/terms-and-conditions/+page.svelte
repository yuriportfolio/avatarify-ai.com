<article class="prose container mx-auto">
	<div>
		...
		<div>
			<div>
				...
				personally or on behalf of an entity (&ldquo;you&rdquo;) and __________&nbsp;("<strong
					>Company</strong
				>", &ldquo;<strong>we</strong>&rdquo;, &ldquo;<strong>us</strong>&rdquo;, or &ldquo;<strong
					>our</strong
				>&rdquo;), concerning your access to and use of the __________ website as well as any other
				media form, media channel, mobile website or mobile application related, linked, or
				otherwise connected thereto (collectively, the &ldquo;Site&rdquo;). You agree that by
		...
		<div>
			<div>
				...
				any reason. We will alert you about any changes by updating the &ldquo;Last updated&rdquo;
		...
		<div>
			<div>
				...
				Site &ldquo;AS IS&rdquo; for your information and personal use only. Except as expressly
		...
		<div>
			...
			<div>
				<div><strong>4. USER REGISTRATION</strong></div>
			</div>
			<div>
				<div>
			...
			<div>
				<div>
					You can cancel your subscription at any time&nbsp;__________. Your cancellation will take
			...
			<div>
				...
				<ul>
					...
					<li>
						Copy or adapt the Site&rsquo;s software, including but not limited to Flash, PHP, HTML,
	...
	<div>
		<div><strong>9. CONTRIBUTION LICENSE</strong></div>
	</div>
	<div>
		<div>
	...
	<div>
		<div>
			...
			these Terms of Use (each "Dispute" and collectively, the &ldquo;Disputes&rdquo;) brought by
			either you or us (individually, a &ldquo;Party&rdquo; and collectively, the
			&ldquo;Parties&rdquo;), the Parties agree to first attempt to negotiate any Dispute (except
	...
	<div>
		...
		COMPLETENESS OF THE SITE&rsquo;S CONTENT OR THE CONTENT OF ANY WEBSITES LINKED TO THE SITE AND
	...
	<div>
		...
		damage, liability, claim, or demand, including reasonable attorneys&rsquo; fees and expenses,
