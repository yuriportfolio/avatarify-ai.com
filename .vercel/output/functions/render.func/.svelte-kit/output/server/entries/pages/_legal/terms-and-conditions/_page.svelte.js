...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<article class="${"prose px-2 lg:prose-xl container mx-auto"}"><div><div><div><a></a><strong>TERMS OF USE</strong></div>
			<div><a></a></div>
			<div><strong>Last updated</strong><strong>December 29, 2022</strong></div></div>

		<div><div><a></a><strong>1. AGREEMENT TO TERMS</strong></div></div>
		<div><div>These Terms of Use constitute a legally binding agreement made between you, whether
				personally or on behalf of an entity (“you”) and __________ (&quot;<strong>Company</strong>&quot;, “<strong>we</strong>”, “<strong>us</strong>”, or “<strong>our</strong>”), concerning your access to and use of the __________ website as well as any other
				...
				of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY
				PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
			</div></div>
		<div><div>Supplemental terms and conditions or documents that may be posted on the Site from time to
		...
		<div><div>The information provided on the Site is not intended for distribution to or use by any
			...
			<div>The Site is intended for users who are at least 13 years of age. All users who are minors in
		...
		<div><div><a></a><strong>2. INTELLECTUAL PROPERTY RIGHTS</strong></div></div>
		<div><div>Unless otherwise indicated, the Site is our proprietary property and all source code,
		...
		<div><div>Provided that you are eligible to use the Site, you are granted a limited license to access
		...
		<div><div><a></a><strong>3. USER REPRESENTATIONS</strong></div></div>
		<div><div>By using the Site, you represent and warrant that: (1) all registration
				information you submit will be true, accurate, current, and complete; (2) you will maintain
				...
				Use; (4) you are not under the age of 13; (5) you are not a minor in the
				jurisdiction in which you reside, or if a minor, you have received parental permission
				to use the Site; (6) you will not access the Site through automated or non-human means,
				whether through a bot, script or otherwise; (7) you will not use the Site for any
				illegal or unauthorized purpose; and (8) your use of the Site will not violate any
				applicable law or regulation.
			</div></div>
		<div><div>If you provide any information that is untrue, inaccurate, not current, or incomplete, we
			...
			<div><div><strong>4. USER REGISTRATION</strong></div></div>
			<div><div>You may be required to register with the Site. You agree to keep your password
			...
			<div><a></a><strong>5. FEES AND PAYMENT</strong></div>
			<div>We accept the following forms of payment:</div>
			<div><div><div>- Visa</div>
					<div>- Mastercard</div></div>
				<div>You may be required to purchase or pay a fee to access some of our services. You agree to
					...
					complete your transactions and contact you as needed. We bill you through an online
				...
				<div>You agree to pay all charges or fees at the prices then in effect for your purchases, and
					you authorize us to charge your chosen payment provider for any such amounts upon making
					your purchase.
				</div>
				<div>We reserve the right to correct any errors or mistakes in pricing, even if we have already
					requested or received payment. We also reserve the right to refuse any order placed
					through the Site.
				</div></div>
			<div><div><a></a></div>
				<div><a></a><strong>6. CANCELLATION</strong></div></div>
			<div><div>You can cancel your subscription at any time __________. Your cancellation will take
					effect at the end of the current paid term.
				</div></div>
			<div><div>If you are unsatisfied with our services, please email us at __________.</div>
				<div><a></a><strong>7. PROHIBITED ACTIVITIES</strong></div></div>
			...
			<div><div>As a user of the Site, you agree not to:</div>
				<ul><li>Systematically retrieve data or other content from the Site to create or compile,
					...
					<li>Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or
					...
					<li>Sell or otherwise transfer your profile.</li></ul></div>
			<div><a></a></div></div>
		<div><div><strong>8. USER GENERATED CONTRIBUTIONS</strong></div></div>
		<div><div><div>The Site may invite you to chat, contribute to, or participate in blogs, message boards,
		...
		<ul><li>The creation, distribution, transmission, public display, or performance, and the accessing,
			...
			<li>Your Contributions are not used to harass or threaten (in the legal sense of those terms)
	...
	<div><div><strong>9. CONTRIBUTION LICENSE</strong></div></div>
	<div><div>By posting your Contributions to any part of the Site, you automatically grant, and you
	...
	<div><div>This license will apply to any form, media, or technology now known or hereafter developed,
	...
	<div><div>We do not assert any ownership over your Contributions. You retain full ownership of all of
	...
	<div><div>We have the right, in our sole and absolute discretion, (1) to edit, redact, or otherwise
	...
	<div><div><a></a><strong>10. SUBMISSIONS</strong></div></div>
	<div><div>You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or other
	...
	<div><a></a><strong>11. SITE MANAGEMENT</strong></div>
	<div><div>We reserve the right, but not the obligation, to: (1) monitor the Site for violations of these
			...
			without limitation, notice, or liability, to remove from the Site or otherwise disable all
		...
		<div><a></a></div></div>
	<div><div><a></a><strong>12. TERM AND TERMINATION</strong></div></div>
	<div><div>These Terms of Use shall remain in full force and effect while you use the Site. WITHOUT
	...
	<div><div>If we terminate or suspend your account for any reason, you are prohibited from registering
	...
	<div><div><a></a><strong>13. MODIFICATIONS AND INTERRUPTIONS</strong></div></div>
	<div><div>We reserve the right to change, modify, or remove the contents of the Site at any time or for
	...
	<div><div>We cannot guarantee the Site will be available at all times. We may experience hardware,
	...
	<div><div><a></a><strong>14. GOVERNING LAW</strong></div>
		<div>These Terms shall be governed by and defined following the laws of __________. __________ and
	...
	<div><div><a></a><strong>15. DISPUTE RESOLUTION</strong></div></div>
	<div><div><strong>Informal Negotiations</strong></div></div>
	<div><div>To expedite resolution and control the cost of any dispute, controversy, or claim related to
			...
			those Disputes expressly provided below) informally for at least __________ days before
			initiating arbitration. Such informal negotiations commence upon written notice from one Party
			to the other Party.
		</div></div>
	<div><div><strong>Binding Arbitration</strong></div></div>
	<div>Any dispute arising out of or in connection with this contract, including any question regarding
		...
		__________. The seat, or legal place, of arbitration shall be __________. The language to be
		used in the arbitral proceedings shall be __________. The governing law of the contract shall be
		the substantive law of __________.
	</div>
	...
	<div>The Parties agree that the following Disputes are not subject to the above provisions concerning
	...
	<div><strong>16. CORRECTIONS</strong></div>
	...
	<div><strong>17. DISCLAIMER</strong></div>
	<div>THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SITE AND
	...
	<div><strong>18. LIMITATIONS OF LIABILITY</strong></div>
	<div>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY
		...
		LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR __________. CERTAIN US STATE LAWS AND
		INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION
		OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR
		LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.
	</div>
	<div><strong>19. INDEMNIFICATION</strong></div>
	<div>You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates,
		...
		Site; (3) breach of these Terms of Use; (4) any breach of your representations and warranties
		set forth in these Terms of Use; (5) your violation of the rights of a third party, including
		...
		you are required to indemnify us, and you agree to cooperate, at your expense, with our defense
		of such claims. We will use reasonable efforts to notify you of any such claim, action, or
		proceeding which is subject to this indemnification upon becoming aware of it.
	</div>
	<div><strong>20. USER DATA</strong></div>
	...
	<div><strong>21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</strong></div>
	<div>Visiting the Site, sending us emails, and completing online forms constitute electronic
		...
		US OR VIA THE SITE. You hereby waive any rights or requirements under any statutes, regulations,
	...
	<div><strong>22. MISCELLANEOUS</strong></div>
	<div>These Terms of Use and any policies or operating rules posted by us on the Site or in respect to
	...
	<div><strong>23. CONTACT US</strong></div>
	<div>In order to resolve a complaint regarding the Site or to receive further information regarding
		use of the Site, please contact us at:
	</div>
	<div><strong>__________</strong></div>
	<div><strong>__________</strong></div>
	<div><strong>__________</strong></div>
	<div><strong>__________</strong></div>
	<div>These terms of use were created using Termly&#39;s <a href="${"https://termly.io/products/terms-and-conditions-generator/"}">Terms and Conditions Generator</a>.
	</div></article>`;
});
export {
  Page as default
