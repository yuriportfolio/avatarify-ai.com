import { c as create_ssr_component, b as subscribe, v as validate_component } from "./index.js";
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"sm:px-4 w-full"}"><div class="${"navbar bg-base-100 drop-shadow-xl sm:rounded-xl mx-auto container max-w-6xl sm:mt-4 w-full"}"><div class="${"navbar-start"}">${validate_component(Button, "Button").$$render(
    ...
    {
      default: () => {
        return `Better Avatar`;
      }
    }
  )}</div>
		<div class="${"navbar-end gap-2"}">${$page.data.session ? `${validate_component(Button, "Button").$$render(
    $$result,
    {
      link: "/login",
      href: "/logout",
